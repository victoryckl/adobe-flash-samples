...
Note: The Flash CS3 Samples.flp file lists the FLAs and AS files in the Flash Project panel so you can open them easily. Double-click the FLP file to open Flash and display the file list in the panel. You can open files in the list by clicking on them. It's provided as a convenience, but it's not necessary for exploring the Flash samples in this archive.
